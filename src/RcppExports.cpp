...
RcppExport SEXP indorigin_TwoStatePhyloLikelihood(SEXP treeEdgesSEXP, SEXP tipStatesSEXP, SEXP branchLengthsSEXP, SEXP lambda_01SEXP, SEXP lambda_10SEXP, SEXP armaRootDistSEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(TwoStatePhyloLikelihood(treeEdges, tipStates, branchLengths, lambda_01, lambda_10, armaRootDist));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(twoStateSufficientStatistics(treeEdges, tipStates, branchLengths, lambda_01, lambda_10, rootDist));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(twoStateCompleteDataLogPosterior(suffStat, lambda_01, lambda_10, prior_alpha_01, prior_beta_01, prior_alpha_10, prior_beta_10));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(twoStatePhyloGibbsSampler(treeEdges, cubeDims, branchLengths, rootDist, tipStates, initial_lambda_01, initial_lambda_10, prior_alpha_01, prior_beta_01, prior_alpha_10, prior_beta_10, mcmcSize, mcmcBurnin, mcmcSubsample));
    return __result;
END_RCPP
}
